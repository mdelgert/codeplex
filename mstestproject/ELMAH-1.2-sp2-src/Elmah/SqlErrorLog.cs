...
namespace Elmah
{
    ...
    public class SqlErrorLog : ErrorLog
    {
        ...
        public SqlErrorLog(IDictionary config)
        {
            ...
            //string connectionString = ConnectionStringHelper.GetConnectionString(config); //ADO connection string
            string connectionString = DAL.Common.GetADOConnectionString();  //Entities connection string
