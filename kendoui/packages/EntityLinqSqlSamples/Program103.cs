    ...
    class Program
    {
        ...
        static void RunExample()
        {
            using (var context = new EFRecipesEntities())
            {
                ...
                recipe1.Steps.Add(new Step { Description = "Slowly add Broth to Rice" });
                recipe1.Ingredients.Add(new Ingredient { Name = "1 Cup White Rice" });
                recipe1.Ingredients.Add(new Ingredient { Name = "6 Cups Chicken Broth"});
                recipe2.Steps.Add(new Step { Description = "Bake at 350 for 35 Minutes" });
